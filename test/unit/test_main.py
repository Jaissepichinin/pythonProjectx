...
def ler_dados_csv():
    dados_csv = []  # criacao de lista vazia
    nome_arquivo = 'C:/Users/jaiss_f3yllmx/PycharmProjects/pythonProject2/test/db/massa_caixa.csv'  # local e nome do arquivo
    try:
        with open(nome_arquivo, newline='') as csvfile:  # repetir a leitura de cada ate acabar o arquivo
